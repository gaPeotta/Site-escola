...
<div class="layout-adm">
    ...
    <div class="sidebar">
        <% 
            // Puxando a sessão 
            String tipoSidebarAdmin = (String) session.getAttribute("tipoUsuario"); 
        %>

        <% if (tipoSidebarAdmin != null && !tipoSidebarAdmin.equalsIgnoreCase("aluno")) { %>
        ...
        <a href="${pageContext.request.contextPath}/ServletReadProfessor" class="active">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <% if (tipoSidebarAdmin != null && tipoSidebarAdmin.equalsIgnoreCase("adm")) { %>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;">
                            <div style="display: flex; gap: 8px; justify-content: center; align-items: center;">
                                <a href="${pageContext.request.contextPath}/ServletUpdateProfessor?id=<%= professor.getIdProfessor() %>" class="btn-editar"
