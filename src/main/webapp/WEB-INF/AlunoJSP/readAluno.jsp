...
<div class="layout-adm">
    ...
    <div class="sidebar">
        <% if (tipoUsuarioLogado != null && !tipoUsuarioLogado.equalsIgnoreCase("aluno")) { %>
        ...
        <a href="${pageContext.request.contextPath}/ServletReadAluno" class="active">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M20.5 8.5V12.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.5 10.5V15.5C6.5 15.5 7 17.5 12 17.5C17 17.5 17.5 15.5 17.5 15.5V10.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Alunos</a>

        <% if (tipoUsuarioLogado != null && (tipoUsuarioLogado.equalsIgnoreCase("adm"))) { %>
